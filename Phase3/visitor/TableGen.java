 ...
 */
public class TableGen<R,A> implements GJVisitor<R,A> {
   //
   ...
   public R visit(MainClass n, A argu) {
      ...
      globalTab.addClass(cname,currScope);
      currScope.cname = cname;
      currScope.fname = "main";
      MethodInfo m = new MethodInfo("main", "public","void");
      globalTab.methodList.put(cname+"_main", m);
      globalTab.classList.get(cname).addMethod(cname+"_main");
      n.f2.accept(this, argu);
   ...
   public R visit(ClassExtendsDeclaration n, A argu) {
      ...
      currScope.depth = 1;
      n.f2.accept(this, argu);
      String par = (String)n.f3.accept(this, argu);
      globalTab.addClass(cname,par,currScope);
      n.f4.accept(this, argu);
      n.f5.accept(this, argu);
      n.f6.accept(this, argu);
      n.f7.accept(this, argu);
   ...
   public R visit(VarDeclaration n, A argu) {
      ...
      if(currScope.depth == 1){
         ClassRecord c = globalTab.classList.get(currScope.cname);
         c.addVar(id,currScope,t);
      }
      n.f2.accept(this, argu);
      return _ret;
   }
   ...
   public R visit(MethodDeclaration n, A argu) {
      ...
      currScope.depth =2;
      MethodInfo m = new MethodInfo(fname,access,type);
      globalTab.addFunction(currScope, m);
      n.f3.accept(this, argu);
      n.f4.accept(this, argu);
      n.f5.accept(this, argu);
      n.f6.accept(this, argu);
   ...
   public R visit(FormalParameter n, A argu) {
      ...
      String id = (String)n.f1.accept(this, argu);
      MethodInfo m = globalTab.methodList.get(currScope.cname+"_"+currScope.fname);
      m.addParam(id,type);
      return _ret;
   }
